...
use_lowT_limit_rates = False
gibbs_text = (
    'thermo/gibbs_text.txt'  # (all the nasa9 files must be placed in the folder: thermo/NASA9/)
)
cross_folder = 'thermo/photo_cross/'
com_file = 'thermo/all_compose.txt'
atm_file = 'atm/atm_Earth_Jan_Kzz.txt'  # TP and Kzz (optional) file
sflux_file = (
    'atm/stellar_flux/Gueymard_solar.txt'  # This is the flux density at the stellar surface
)
...
T_cross_sp = [
    ...
    'H2O',
    'NH3',
]  # warning: slower start! available atm: 'CO2','H2O','NH3', 'SH','H2S','SO2', 'S2', 'COS', 'CS2'
...
gs = 980.0  # surface gravity (cm/s^2)  (HD189:2140  HD209:936)
...
use_fix_sp_bot = {
    ...
    'H2O_l_s': 0,
    'CO2': 4e-4,
}  #   0.0143 for 40% humidity 0.0033 for 20% humidity in US standard 1967 # fixed mixing ratios at the lower boundary
...
fix_species = [
    ...
    'H2SO4',
    'H2SO4_l',
]  # fixed the condensable species after condensation-evapoation EQ has reached
...
rtol = 1.0  # relative tolerence for adjusting the stepsize
...
use_shark = False
save_evolution = (
    False  # save the evolution of chemistry (y_time and t_time) for every save_evo_frq step
)
save_evo_frq = 10
